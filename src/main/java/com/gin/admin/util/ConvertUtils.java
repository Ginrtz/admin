...
public class ConvertUtils {
	 ...
	 * @throws IntrospectionException
	 */
	private static <T> T basicfromJava(Map<String, ? extends Object> map, Class<T> classOfItem)
			throws IllegalArgumentException, IntrospectionException {
		if (String.class.isAssignableFrom(classOfItem) || Number.class.isAssignableFrom(classOfItem)
				|| Boolean.class.isAssignableFrom(classOfItem) || Date.class.isAssignableFrom(classOfItem)) {
			return fromOnlyOneField(map, classOfItem);
		}
		T obj = null;
	 ...
	 * @throws IntrospectionException
	 */
	public static <T> T fromJava(Map<String, ? extends Object> map, Class<T> classOfItem)
			throws IllegalArgumentException, IntrospectionException {
